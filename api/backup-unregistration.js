...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const backupEntry = {
            ...
            backup_type: 'unregistration'
        };

        // Pridanie novej odregistrácie
        ...
        const logEntry = `[${new Date().toISOString()}] UNREGISTRATION: ${registracia.meno} (${registracia.email}) - Termín: ${registracia.termin_id}\n`;
        ...
        res.status(200).json({ 
            success: true, 
            message: 'Unregistration backed up successfully',
